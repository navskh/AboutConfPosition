 ...
 * [김경환,야마다,심원,이정현,이은상,장준영,강희상,김지용,손승운,박태준,오영탁,김선욱,김영욱,정재원,이승우,여상구,조일현,손명한]
 *
...
const 선호빈 = new Student(
    "선호빈",
    "2024-15739",
    "010-5182-1712",
    "농업생명과학대학 바이오시스템·소재학부"
);
const 조정황 = new Student(
    "조정황",
    "2019-14273",
    "010-3548-3873",
    "사회과학대학 경제학부"
);
const 안준영 = new Student(
    "안준영",
    "2024-16390",
    "010-3763-2840",
    "음악대학 작곡과"
);
const 임은찬 = new Student(
    "임은찬",
    "2024-12314",
    "010-4549-2742",
    "첨단융합학부"
);
const 강재희 = new Student(
    "강재희",
    "2024-19518",
    "010-9154-9401",
    "사범대학 체육교육과"
);
const 김재훈 = new Student(
    "김재훈",
    "2024-19441",
    "010-2465-2016",
    "공과대학 전기정보공학부"
